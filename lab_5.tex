...
\begin{itemize}
    ...
    \item Divergence angles: $\theta_{\parallel } = 6 ^{\circ} = 0.104 ~\mathrm{rad}$ and $\theta_{\perp } = 24^{\circ} = 0.409~\mathrm{rad}$
\end{itemize}
\subsection{In Lab}
\subsubsection*{MPE}
For $t=0.25s$:
...
\begin{figure}[H]
    ...
    \label{fig:diagrams}
\end{figure}
The value of the feedback resistor $R_{f}$ is chosen to be $26.7\mathrm{k\Omega}$  and the protection resistance is $R_{p} = 2.17\mathrm{k\Omega}$. For the resistance used in the 2 and 4 wire circuit, their values are $R = 2.2\mathrm{k\Omega}$.
...
The use of 4-wire measurements proved advantageous, as they eliminated lead and contact resistances, resulting in more accurate voltage readings and lower calculated internal resistances.  

Limitations of the experiment include measurement noise, calibration uncertainties in the photoreceiver, and potential temperature effects on device performance. Future work could involve temperature-controlled measurements, improved detector calibration, and exploration of higher current ranges to investigate efficiency drop in LEDs more thoroughly.  
...
\begin{itemize}
    \item Red LED: \href{https://github.com/123700659-gif/lasers_and_leds/blob/b06cbedd6583ba8bb4b780d5e56fc3c27b4dd94d/commands/Device_Characterization_Data_Red26.7k_fr_current_power.csv}{Full data sheet}
    \item Amber LED: \href{https://github.com/123700659-gif/lasers_and_leds/blob/b06cbedd6583ba8bb4b780d5e56fc3c27b4dd94d/commands/Device_Characterization_Data_Amber26.7k_fr_current_power.csv}{Full data sheet}
    \item Green LED: \href{https://github.com/123700659-gif/lasers_and_leds/blob/b06cbedd6583ba8bb4b780d5e56fc3c27b4dd94d/commands/Device_Characterization_Data_Green26.7k_fr_current_power.csv}{Full data sheet}
    \item Blue LED: \href{https://github.com/123700659-gif/lasers_and_leds/blob/b06cbedd6583ba8bb4b780d5e56fc3c27b4dd94d/commands/Device_Characterization_Data_Blue26.7k_fr_current_power.csv}{Full data sheet}
    \item Laser: \href{https://github.com/123700659-gif/lasers_and_leds/blob/b06cbedd6583ba8bb4b780d5e56fc3c27b4dd94d/commands/Device_Characterization_Data_Laser26.7k_fr_with_power.csv}{Full data sheet}
\end{itemize}
\href{https://github.com/123700659-gif/lasers_and_leds/blob/b06cbedd6583ba8bb4b780d5e56fc3c27b4dd94d/commands/Commands.ipynb}{Code used for data collection, analysis and plotting}
\end{document}